...
In my [last post](/2025/bag-notation/), about the bag notation language, I mentioned that one of the next tasks was to create an extension for the zed editor. I have finished a first version of this, and it can be installed locally in developer mode.
