...
* A [preview page](/site/mist/preview) contains example swatches for syntax highlighting themes and the full palette.
* The [main theme page](/site/mist) contains all the hex codes and syntax assignments.
