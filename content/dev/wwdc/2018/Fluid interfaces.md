...
No waiting, allow input during processing of previous input
...
Smooth frames of motion, limited by framerate
Work with behavior rather than animation

Elasticity, returning to a resting state
Simplify to Damping% and response time (damping ratio and frequency response)
