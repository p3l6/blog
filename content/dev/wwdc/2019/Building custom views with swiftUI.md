...
Layout priority will affect how stacks offer space to its children. The heights priority is offered all of the space before the others.
...
You can use drawingGroup() to flatten all the swiftUI views into a single one for efficient rendering with metal. But only for shapes and drawing.
