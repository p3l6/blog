...
A view defines it’s dependencies, by specifying `@state` on the property. Runtime keeps track of which state variables are read/written to know when to re-call the body. It will call body whenever it needs to draw.
