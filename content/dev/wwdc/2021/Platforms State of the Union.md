...
* Focus
  * Ranks notifications based on "interruption levels"
    ...
    * Critical notifications are for safety, will need a approved entitlement
...
* Widgets for iPad
  ...
  * Widget suggestions for smart stacks
* SharePlay
  * Media is not 're-streamed' over facetime. shareplay only synchronizes the playback.
  * No loss in quality
