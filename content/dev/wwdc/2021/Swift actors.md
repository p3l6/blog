...
* Nonisolated keyword allows declaring functions that seem inside the actor, but aren’t. These cannot access mutable state. Useful in protocol conformance sometimes.
