...
* Hosting controllers will set themselves to the ideal size of the contained view. Swiftui will push min/max sizes up to the next level for you, and set some layout constraints.
