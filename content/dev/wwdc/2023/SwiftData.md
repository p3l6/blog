...
* `@Model` Normal swift code defines schema
  ...
  * `@Attribute`, `@Relationship` controls how properties are inferred
    * unique, cascade, etc
...
* `@Attribute(originalName: )` for renaming properties without migration
...
* Complete adoption
  ...
  * Remove unneeded explicit saves
